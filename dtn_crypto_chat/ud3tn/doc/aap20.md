# Application Agent Protocol (AAP) - Version 2
...
!!! note
    ...
    - Please refer to [**the current Protobuf source**](https://gitlab.com/d3tn/ud3tn/-/blob/master/components/aap2/aap2.proto) for a definition of the messages and structures described here.
