...
# Config variables - first instance: Earth
A_NAME="Earth"
A_EID="dtn://earth.dtn/"
A_AGENTID="earth"
A_SOCKET="ud3tn-earth.aap2.socket"
A_AAP_PORT=5243
A_MTCP_PORT=5225
A_IP_ADDRESS="localhost"

# Config variables - second instance: Pluto
B_NAME="Pluto"
B_EID="dtn://pluto.dtn/"
B_AGENTID="pluto"
B_SOCKET="ud3tn-pluto.aap2.socket"
B_AAP_PORT=5244
B_MTCP_PORT=5226
...
# Start user Earth:
echo "Setting up uD3TN user \"Earth\" ..."
...
# Start user Pluto:
echo "Starting second uD3TN user \"Pluto\" ..."
...
# CA <=> Earth:
echo "Configuring contact between \"CA\" and \"Earth\" ..."
...
# CA <=> Pluto:
echo "Configuring contact between \"CA\" and \"Pluto\" ..."
...
# Earth <=> Pluto:
echo "Configuring contact between \"Earth\" and \"Pluto\" ..."
...
# Write Earth's configuration to a file:
cat <<EOL > earth_config
[user]
eid=$A_EID
agentid=$A_AGENTID
...
# Write Pluto's configuration to a file:
cat <<EOL > pluto_config
[user]
eid=$B_EID
agentid=$B_AGENTID
